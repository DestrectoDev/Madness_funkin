...
class ModchartState 
{
    ...
    function new()
    {
				...
				setVar("curStep", 0);
				setVar("curBeat", MusicBeatState.instanceBeat);
				...
				Lua_helper.add_callback(lua,"angleIconTween", function (toangle:Float, duration:Float, easeShit:String) {
					FlxTween.tween(PlayState.instance.iconP1, {angle: toangle}, duration, {ease: getFlxEaseByString(easeShit)});
				});

				Lua_helper.add_callback(lua,"angleIconp2Tween", function (toangle:Float, duration:Float, easeShit:String) {
					FlxTween.tween(PlayState.instance.iconP2, {angle: toangle}, duration, {ease: getFlxEaseByString(easeShit)});
				});

				Lua_helper.add_callback(lua,"xIconTween", function (toX:Float, duration:Float, easeShit:String) {
					FlxTween.tween(PlayState.instance.iconP1, {x: toX}, duration, {ease: getFlxEaseByString(easeShit)});
				});
				Lua_helper.add_callback(lua,"xIconp2Tween", function (toX:Float, duration:Float, easeShit:String) {
					FlxTween.tween(PlayState.instance.iconP2, {x: toX}, duration, {ease: getFlxEaseByString(easeShit)});
				});
				...
				Lua_helper.add_callback(lua,"tweenHudToX", function(toX:Float, time:Float, easeType:String) {
					FlxTween.tween(PlayState.instance.camHUD, {x: toX}, time, {ease: getFlxEaseByString(easeType)});
				});
								
				Lua_helper.add_callback(lua,"tweenHudAngle", function(toAngle:Float, time:Float, easeType:String) {
					FlxTween.tween(PlayState.instance.camHUD, {angle:toAngle}, time, {ease: getFlxEaseByString(easeType)});
				});
